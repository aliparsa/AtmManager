...
namespace Atm_Manager {
    ...
    public partial class atmDataSet : global::System.Data.DataSet {
        ...
        public partial class productDataTable : global::System.Data.TypedTableBase<productRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public productRow AddproductRow(string name, string serial_number) {
        ...
        public partial class productRow : global::System.Data.DataRow {
            ...
            public string serial_number {
                get {
                    try {
                        return ((string)(this[this.tableproduct.serial_numberColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'serial_number\' in table \'product\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableproduct.serial_numberColumn] = value;
                }
            }
            ...
            public bool Isserial_numberNull() {
                return this.IsNull(this.tableproduct.serial_numberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void Setserial_numberNull() {
                this[this.tableproduct.serial_numberColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Atm_Manager.atmDataSetTableAdapters {
    ...
    public partial class productTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `product` WHERE ((`ID` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name" +
                "` = ?)) AND ((? = 1 AND `serial_number` IS NULL) OR (`serial_number` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `product` (`name`, `serial_number`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `product` SET `name` = ?, `serial_number` = ? WHERE ((`ID` = ?) AND ((? = " +
                "1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `serial_number` IS NULL) " +
                "OR (`serial_number` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Atm_Manager.Properties.Settings.Default.Setting1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, name, serial_number FROM product";
        ...
        public virtual int Fill(atmDataSet.productDataTable dataTable) {
        ...
        public virtual atmDataSet.productDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            atmDataSet.productDataTable dataTable = new atmDataSet.productDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(atmDataSet.productDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_name, string Original_serial_number) {
        ...
        public virtual int Insert(string name, string serial_number) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string serial_number, int Original_ID, string Original_name, string Original_serial_number) {
            if ((name == null)) {
